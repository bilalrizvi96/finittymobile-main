...
import 'package:charles_app/View/Laundry/LoundryBook.dart';
import 'package:charles_app/View/Laundry/dryClean.dart';
import 'package:charles_app/View/Laundry/washFold.dart';
import 'package:charles_app/View/Laundry/washIron.dart';
import 'package:charles_app/widgets/bottomModal.dart';
import 'package:dio/dio.dart';
import 'package:flutter_staggered_grid_view/flutter_staggered_grid_view.dart';
import 'package:fluttertoast/fluttertoast.dart';

import '../../API/Cartmodal.dart';
import '../../Component/searchButton.dart';
import '../../Model/Cleaning/cleaningList.dart';
...
import '../Caring/CarDriveAway.dart';
import '../Cleaning/RoundedIconButton.dart';
...
var image = <String>[
  "lib/assets/images/sitterimg.png",
  "lib/assets/images/psw.png",
  "lib/assets/images/nurseimg.png",
  "lib/assets/images/footcareimg.png",
  "lib/assets/images/dentist1.png",
];
class _LaundryState extends State<Laundry>with TickerProviderStateMixin {

  void Model() {
    money = valcarlist[selectindex].money;
    //firstindex = valcarlist[selectindex];
    print(firstindex);
    modaldata.clear();
  ...
  void DataCalling1() {
    String url = baseurl + "/api/loundry";
    Dio dio = new Dio();
    carlist.clear();
    addonslist.clear();
    int imindex= -1;
            ...
            for (Map caringcat in i['categories']) {
              ...
              for (Map homesubcarpkges in caringcat['package_categories']) {
                ...
                homesubcarpkg.add(Homesubcle(
                  ...
                  homesubcarpkges['caring_category_id'].toString(),
                ));
                for (Map subsubpkg in homesubcarpkges['packages']) {
                  carlist.add(CleaningRoomsTab(
                      ...
                      subsubpkg['caring_package_category_id'].toString(),
                      homesubcarpkges['name'],
                      false,
                      homesubcarpkges['caring_category_id'],
    ...
    setState(() {
      if (homesubcarpkg != null) {
        for (var val in homesubcarpkg) {
          if (val.cid.toString() == selectedIndextabcar.toString()) {
  ...
  addcounter(int index) {
    ...
    setState(() {
      money =
          (int.parse(a[1]) + int.parse(modaldata[index].price)).toString();
      money = "\$ " + money;
      money = money;
    });
  ...
  Widget listaddon() {
    return SizedBox(
      ...
      child: ListView.builder(
          ...
          itemBuilder: (_, index) {
            return addons(addonslist[index]);
          }),
    );
  }
  Widget addons(addonslist){
    return  Padding(
          ...
          Column(
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.all(
                        Radius.circular(5))),
                child: Center(
                    child: Text(addonslist.cattitle==null?"Bags/Discard":addonslist.title,
              ...
              Container(
                  width: 90,
                  // color: Colors.blue,
                  child: Center(child: Text(addonslist.price==null?"15\$":addonslist.price.toString()))),
            ],
          ),
          //SizedBox(width: 10,),
          // Column(
                                          ...
                                          onTap: () {
                                            setState(() {
                                              if(caringcatlist[selctedtabind].addons[index].selected==true)
                                              {
                                                ...
                                                selectedaddonsnameList.remove(caringcatlist[selctedtabind].addons[index].title);
                                                selectedaddonspriceList.remove(caringcatlist[selctedtabind].addons[index].price);
                                                ...
                                                selectedaddonsnameList.add(caringcatlist[selctedtabind].addons[index].title);
                                                selectedaddonspriceList.add(caringcatlist[selctedtabind].addons[index].price);
      ...
      return new Padding(
        ...
        child: StaggeredGridView.countBuilder(
              ...
              child: AnimatedContainer(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(height: 85, child: inner(subitemindex)),
          ...
          new StaggeredTile.count(
              2, valcarlist[index].selected == false ? 1.52 : 2),
                                      ...
                                      child: InkWell(
                                        child: Container(
                                          ...
                                          height: MediaQuery.of(context)
                                              ...
                                              10,
                                          child: Card(
                                            color: selectedIndextabcar != null &&
                                                selectedIndextabcar ==
                                        ...
                                        onTap: () {
                                          setState(() {
                                            ...
                                            _onSelected(
                                                caringcatlist[index].id);
                                            subpkgname=caringcatlist[index].title;
                                            //DataCalling1();
                                            //valid=controller.index;
                                            uppertabindex = 0;
                                            lowertabindex = 0;
